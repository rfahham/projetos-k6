...
var _default = function _default() {
  ...
  (0, _k.group)('https://globoplay.globo.com/ - Troca de canais.', function () {
    _http["default"].get("https://cloud-jarvis.globo.com/graphql?variables={\"id\":\"".concat(broadcastOffer, "\",\"affiliateCode\":\"").concat(affiliateCode, "\"}&extensions={\"persistedQuery\":{\"version\":1,\"sha256Hash\":\"8ce3f8eb191d7fbdbd4f4f3a01fa5db67a541da3e8dfd590ca73dacdf42e664f\"}}"), {
      headers: headers,
      timeout: timeout
    });
  });
